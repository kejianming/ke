...
public class UserController extends BaseController {
    ...
    @ResponseBody
    public JsonUtil addUser(SysUser user, String[] role, HttpServletResponse response) {
        if (user == null) {
    ...
    @Log(desc = "用户管理:更新用户", type = LOG_TYPE.UPDATE)
    @PostMapping(value = "updateUser")
    @ResponseBody
    public void updateUser(SysUser user, String role[],HttpServletResponse response) {
    ...
    @Log(desc = "用户管理:删除用户", type = LOG_TYPE.DEL)
     ...
     * @return
     */
    @Log(desc = "用户管理:修改密码", type = LOG_TYPE.UPDATE)
