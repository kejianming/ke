...
<script type="text/html" id="toolBar">
  ...
  <a class="layui-btn layui-btn-danger layui-btn-xs" lay-event="showproinstan"><i class="layui-icon">&#xe640;</i>查看流程实例</a>
</script>
<script>
  ...
  layui.use('table', function () {
    ...
    table.render({
      ...
      , cols: [[
        ...
        , {field: 'text', title: '操作', width: '15%', toolbar:'#toolBar'}
    ...
    //监听工具条
      ...
      if (obj.event === 'showproinstan') {
          showProInstan(data.deploymentId);
      }
  ...
  function showProInstan(id) {
    window.location.href="${re.contextPath}/act/goProcessInstance?deploymentId="+id
  }
