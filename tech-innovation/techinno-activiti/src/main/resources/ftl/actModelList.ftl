...
<script type="text/html" id="toolBar">
    <shiro.hasPermission name="control:del">
        ...
        <#--{{# if(!d.deploymentId){ }}-->
        <a class="layui-btn layui-btn-danger layui-btn-xs" lay-event="open"><i class="layui-icon">&#xe640;</i>更新</a>
        <#--{{# } }}-->
        ...
        <div style="width:100%;overflow: auto;">
            <div class="layui-form-item">
                ...
                <div class="layui-input-block">
                    <input type="text" name="name" id="name" lay-verify="name" placeholder="输入名称"
            ...
            <div class="layui-form-item">
                ...
                <div class="layui-input-block">
                    <input type="text" name="key" id="key" lay-verify="key" placeholder="输入键" autocomplete="off"
                           class="layui-input">
                </div>
            </div>
            <div class="layui-form-item">
                ...
                <div class="layui-input-block">
                    <input type="text" name="description" id="description" lay-verify="description" placeholder="输入描述"
                           class="layui-input">
                </div>
            </div>
        </div>
        <div style="width: 100%;height: 56px;background-color: white;border-top:1px solid #e6e6e6;position: sticky;bottom: 1px;">
            <div class="layui-form-item" style="float:right;margin-right:30px;margin-top:8px">
                <button class="layui-btn layui-btn-normal" lay-filter="save" lay-submit="" id="save">
                    保存
                </button>
                <input type="reset" class="layui-hide">
            </div>
        </div>
    </form>
</div>
    ...
    layui.use(['form', 'table'], function () {
        ...
        form.on('submit(save)', function (data) {
            ...
            var index = layer.open({
                ...
                shade: 0.4,
                title: '添加流程',
                content: 'goActiviti?name=' + data.field.name + '&key=' + data.field.key + '&description=' + data.field.description,
                end: function () {
