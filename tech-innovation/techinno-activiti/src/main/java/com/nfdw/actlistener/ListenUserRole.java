...
public class ListenUserRole {
     ...
     * @param joinPoint
     */
    @Around("execution(com.nfdw.util.JsonUtil com.nfdw.controller.UserController.updateUser(*,String[]))")
     ...
     * @param joinPoint
     */
    @Around("execution(com.nfdw.util.JsonUtil com.nfdw.controller.UserController.addUser(*,String[]))")
    ...
    @Around("execution(com.nfdw.util.JsonUtil com.nfdw.controller.UserController.del(..))")
    public Object listenDelUser(ProceedingJoinPoint point) throws Throwable {
        ...
        if ((boolean) args[1]) {
            if (util.isFlag()) {
                List<SysRoleUser> roleUsers = ((List<SysRoleUser>) util.getData());
                for (SysRoleUser roleUser : roleUsers
                ) {
                    identityService.deleteMembership((String) args[0], roleUser.getRoleId());
                }
                identityService.deleteUser((String) args[0]);
                userService.deleteByPrimaryKey((String) args[0]);
            }
        }
        return o;
    }
     ...
     * @param obj
     */
    private void updateUser(Object[] obj, List<String> strings) {
        SysUser user = (SysUser) obj[0];
    ...
    /**********************角色处理begin***************************/
    @Around("execution(com.nfdw.util.JsonUtil com.nfdw.controller.RoleController.addRole(*,String[]))")
    ...
    @Around("execution(com.nfdw.util.JsonUtil com.nfdw.controller.RoleController.updateUser(*,String[]))")
    ...
    @Around("execution(com.nfdw.util.JsonUtil com.nfdw.controller.RoleController.del(..))")
